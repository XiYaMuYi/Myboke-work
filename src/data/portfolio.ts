...
export const MOCK_EXPERIENCE: IExperience[] = [
  {
    ...
    position: 'AI FDE 前沿部署工程师',
    description: [
      '主导电商智能客服多轮对话能力建设，设计任务型对话流程，引入Function Calling、状态机与MCP工具解耦机制',
      '负责企业内部多模态文档解析链路建设，设计OCR与视觉大模型融合解析方案',
      '主导企业知识库RAG检索链路建设，设计关键词检索与语义检索结合的混合检索方案',
      '参与企业BI智能报表系统开发，构建Text-to-SQL能力',
      '参与金融账务领域大模型适配与对齐优化工作，基于LoRA微调与偏好对齐方案',
    ],
  },
  {
    id: '2',
    ...
    position: 'Python自动化测试工程师',
    description: [
      '负责对接内部新零售中台及电商后台系统，主导跨部门、跨服务接口的逻辑联调与质量验证',
      '负责API接口交互设计与容错验证，积累较强的接口异常分析、问题定位与数据流梳理能力',
      '参与Web、小程序等多端系统联调，对复杂业务链路中的数据同步、异常处理和稳定性验证有较强经验',
    ],
  },
  {
    id: '3',
